...
//  BackOn
//
//  Created by Riccio Vincenzo, Sorrentino Giancarlo, Triuzzi Emanuele, Zanfardino Gennaro on 20/02/2020.
    ...
    var body: some View {
        ScrollView {
            ZStack(alignment: .top) {
                ...
                self.content.alignmentGuide(.top, computeValue: { d in (self.refreshing && self.frozen) ? -self.threshold : 0.0 })
