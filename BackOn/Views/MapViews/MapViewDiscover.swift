...
//        print(mapView)
    ...
    func updateUIView(_ uiView: MKMapView, context: Context) {
        ...
        for (_, discoverableCommitment) in shared.discoverSet {
            ...
            annotation.title = discoverableCommitment.userInfo.name
            annotation.subtitle = discoverableCommitment.title
            annotation.coordinate = discoverableCommitment.position.coordinate
...
//            }
        ...
        let region = MKCoordinateRegion(center: shared.locationManager.lastLocation?.coordinate ?? (shared.discoverSet.first?.value.position.coordinate)!, span: span)
