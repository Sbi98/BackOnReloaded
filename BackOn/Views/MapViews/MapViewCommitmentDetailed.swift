...
struct MapViewCommitmentDetailed: UIViewRepresentable {
    ...
    class Coordinator: NSObject, MKMapViewDelegate {
        var parent: MapViewCommitmentDetailed

        init(_ parent: MapViewCommitmentDetailed) {
            self.parent = parent
        }
    ...
    func makeUIView(context: Context) -> MKMapView {
        if let mapView = MapViewCommitmentDetailed.mapViewStore[key] {
           return mapView
        }
        ...
        MapViewCommitmentDetailed.mapViewStore[key] = mapView
//        print(mapView)
        return mapView
    }
